...
if ! which docker-compose >/dev/null 2>&1; then curl -Lk https://raw.githubusercontent.com/xiaoyawl/centos_init/master/docker/docker-compose-install.sh|bash; fi
